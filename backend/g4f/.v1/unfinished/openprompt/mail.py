...
class MailClient:
    ...
    def destroy(self):
        ...
        self.response = requests.delete(
            f"https://www.developermail.com/api/v1/mailbox/{self.username}",
            headers=headers,
        )
        self.response = self.response.json()
        self.username = None
    ...
    def newtoken(self):
        ...
        self.response = requests.put(
            f"https://www.developermail.com/api/v1/mailbox/{self.username}/token",
            headers=headers,
        )
        self.response = self.response.json()
        self.token = self.response["result"]["token"]
    ...
    def getmails(self, mailids: list = None):
        ...
        self.response = requests.post(
            f"https://www.developermail.com/api/v1/mailbox/{self.username}/messages",
            headers=headers,
            data=data,
        )
        self.response = self.response.json()
    ...
    def getmail(self, mailid: str, raw=False):
        ...
        self.response = requests.get(
            f"https://www.developermail.com/api/v1/mailbox/{self.username}/messages/{mailid}",
            headers=headers,
        )
        self.response = self.response.json()
