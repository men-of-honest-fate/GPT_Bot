...
from g4f.Provider import (Aichat, Ails, Bard, Bing, ChatgptLogin, DeepAi,
                          Forefront, GetGpt, H2o, Liaobots, Lockchat, Theb,
                          Vercel, You, Yqcloud)
...
for provider in providers:
    ...
    print(
        f"| {url} | {name} | {has_gpt3_5} | {has_gpt4} | {streaming} | ![Active](https://img.shields.io/badge/Active-brightgreen) | {needs_auth} |"
    )
